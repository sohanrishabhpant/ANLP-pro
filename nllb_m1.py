...
def main():
    ...
    try:
        ...
        translator = LoRATranslator(
            experiment_name="nllb_lora_en_hien_translation",
            lora_r=16,
            lora_alpha=32,
            lora_dropout=0.1
        )
        ...
        # Save LoRA weights
        output_path = Path("./models/nllb_lora_m1")
        ...
        output_file = "lora_translations_results.txt"
