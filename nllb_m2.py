...
class LoRATranslator:
    """NLLB translation model with LoRA fine-tuning."""
    def __init__(
        self,
        model_name: str = "facebook/nllb-200-distilled-600M",
        max_length: int = 128,
        experiment_name: str = "nllb_lora_translation",
        lora_r: int = 16,
        lora_alpha: int = 32,
    ...
    def train(
        ...
        """Train the translation model with LoRA."""
        try:
            # Initialize wandb
            if wandb_entity:
                wandb.init(
                    project="nllb_lora_translation_hi",
            ...
            # Set up training arguments optimized for LoRA
...
def main():
    """Main function to run the LoRA translation pipeline."""
    try:
        # Initialize data manager and load data
        data_manager = DataManager("../Dataset/hi-hien")
        ...
        # Initialize and train translator with LoRA
        translator = LoRATranslator(
            experiment_name="nllb_lora_hi_hien_translation",
            lora_r=16,
            lora_alpha=32,
            lora_dropout=0.1
        )
        ...
        trainer = translator.train(
            tokenized_datasets,
            output_dir="./nllb_lora_translation_results",
            num_epochs=5,
            batch_size=4,
            learning_rate=1e-4,
        ...
        # Save LoRA weights
        output_path = Path("./models/nllb_lora_m2")
        ...
        output_file = "lora_translations_results_hi.txt"
